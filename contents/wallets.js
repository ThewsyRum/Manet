   ...
   const walletSty = StyleSheet.create({
    ...
    return ( 
        <View style={walletSty.wallet}>
            ...
            <Text style={{flex:2, paddingLeft:'1%',color:scheme === 'dark'?"black":"black",textAlign:'right'}}>{props.sign!='no'?'$':''}{parseFloat(parseFloat(props.balance).toFixed(2)).toLocaleString('en')}</Text>
